...
{if $currentMeetup}
    <article class="meetup meetup-current">
        <h3>{_ "Current Meetup"} <i style="color:#dd3333" class="fa fa-meetup" aria-hidden="true"></i></h3>
...
{if $nextMeetup}
    <article class="meetup meetup-next">
        <h3>{_ "Next Meetup"} <i style="color:#dd3333" class="fa fa-meetup" aria-hidden="true"></i></h3>
        {meetup $nextMeetup}
    </article>
{/if}

{if count($futureMeetups)}
    <h3>{_ "Future Meetups"} <i style="color:#dd3333" class="fa fa-meetup" aria-hidden="true"></i></h3>
